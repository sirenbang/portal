...
<html>
  <head>
    ...
    <title>门户组管理</title>
    <script type="text/javascript" src="./allPortalLayout.js"></script>
    <style type="text/css">
    	li {
    		font-size: small;
    	}
  ...
  <body>
  	...
  	<input type="hidden" id="updatePortalLayoutId" value="${session.updatePortalLayout.id }"/>
  	<div style="display: none;">
  		<!-- 退出form start -->
  		<form action="logoutAction" id="logout-form"></form>
  		<!-- 退出form end -->
  		<!-- 翻页form start -->
  		<form action="showPortalLayoutAction" id="showRole-form">
    ...
    <!-- top start -->
		...
		<div class="ui-layout-center" style="text-align:center;">
			<form id="searchRole-form" action="./showPortalGroupAction" method="post">
				门户排版名：<input type="text" name="searchPortalLayoutName" value="${searchPortalLayoutName }" id="searchPortalGroupName" class="text ui-widget-content ui-corner-all"  /> &nbsp;&nbsp;&nbsp;&nbsp;
