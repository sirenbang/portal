    ...
    <!-- top start -->
		...
		<div class="ui-layout-center">
			...
			<table style="width: 100%">
				<s:iterator var="portletDescription" value="#attr.allPortlets" status="st">
					<s:if test="#st % 3 == 1">
						<tr>
					</s:if>
						<td style="width: 33%;vertical-align: middle;text-align: center;"> 
							<s:if test="#portletDescription.imagePath == null">
								<img alt="${portletDescription.name }" src="./images/default.jpg"/>
							</s:if><s:else>
