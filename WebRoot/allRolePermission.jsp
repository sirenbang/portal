...
<html>
  <head>
    ...
    <title>角色授权</title>
    <script type="text/javascript" src="./allRolePermission.js"></script>
    <style type="text/css">
    	li {
    		font-size: small;
    	}
  ...
  <body>
    ...
    <!-- top start -->
		...
		<div class="ui-layout-center" style="text-align:center;">
			<form id="searchRole-form" action="./showRolePermissionAction" method="post">
				...
				<tbody>
					<s:iterator var="showRole" value="#session.showRoles" status="st">
						<tr <s:if test="#st.odd">style="background-color:#BBBBBB"</s:if>>
							...
							<td>
								<a href="authorizeRole?id=${showRole.id }">授权</a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
